                ...
                {config ? (
                    <>
                        ...
                        <div className="flex gap-2">
                            ...
                            <a href="/auth/login?mode=srp_config" className="btn-secondary text-xs py-2 px-4 border-amber-500/30 text-amber-400 hover:bg-amber-500/10">
                    ...
                    <>
                        ...
                        <div>
                            <a href="/auth/login?mode=srp_config" className="btn-primary text-xs py-2 px-6 inline-flex gap-2">
