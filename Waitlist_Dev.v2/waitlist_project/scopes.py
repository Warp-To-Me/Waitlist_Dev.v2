SCOPE_DESCRIPTIONS = {
    ...
    "publicData": {
        "label": "Public Data",
        "description": "Access public character information."
    },
    ...
    "esi-fleets.read_fleet.v1": {
        "label": "Read Fleet",
        "description": "View fleet composition (Required for FCs)."
    },
    "esi-fleets.write_fleet.v1": {
        "label": "Write Fleet",
        "description": "Manage fleet settings and members (Required for FCs)."
    },

    # SRP SCOPES
    "esi-wallet.read_corporation_wallets.v1": {
        "label": "Read Corp Wallets",
        "description": "View corporation wallet journal (Required for SRP Managers)."
    },
}
